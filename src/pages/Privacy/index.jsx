...
const Privacy = () => {
    return (
        <>
            <Navbar />
            <div className="p-5 my-10 max-w-4xl mx-auto font-sans">
                ...
                <p className="text-base  mt-4 leading-6">
                    If you wish to subscribe to our newsletters, we will use your name and email address to send the newsletter to you. Out of respect for your privacy, we provide you with a way to unsubscribe in the email. If you wish to no longer receive our newsletters, you may update the settings in your account, follow the instructions located in the email, or you may contact us at support@MyTimeStation.com.
                </p>
